...
gait_collection = db["gait_analysis"] # Name of the collection in the MongoDB database that contains gait angle data.
# -------------------------------------------------------------------------------
...
# We retrieve the collection (gait_collection) containing gait analysis data from MongoDB.
for doc in gait_collection.find():
